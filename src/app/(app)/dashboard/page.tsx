        ...
        <div className="space-y-3 bg-white px-5 py-5 sm:px-6">
          ...
          <div className="mt-4 flex justify-end">
            <Link href="/transactions">
              <Button className="bg-slate-50 text-white hover:bg-slate-700">
      ...
      <div className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
        <Card>
          <CardHeader>
            ...
            <Badge className="bg-sky-50 text-sky-700">Nuevo</Badge>
          </CardHeader>
          <CardContent>
            ...
            <div className="space-y-4 rounded-[28px] bg-slate-50 p-4">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={item.label} className="flex items-center justify-between gap-4 rounded-3xl border border-slate-200 bg-white p-4">
                    <div>
                      <p className="text-sm font-semibold text-slate-900">{item.label}</p>
                      <p className="text-sm text-slate-500">{item.trend} increase</p>
                    </div>
