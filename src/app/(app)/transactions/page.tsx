...
// Lenguaje visual idéntico al Dashboard/Inicio.
...
export default function TransactionsPage() {
  ...
  // Filtros, búsqueda y ordenamiento (client-side, sobre datos ya filtrados por RLS).
  ...
  // Key de idempotencia estable por "intención de operación".
  ...
  // Maps para resolver nombres en el listado (reutiliza datos ya cargados).
  ...
  // Listado filtrado + buscado + ordenado (client-side).
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Validaciones UI (los mensajes en español; la lógica financiera queda en finance.ts).
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  ...
                  className="h-12 rounded-2xl border border-slate-200 bg-white px-4 text-base outline-none transition focus:border-violet-400"
                >
