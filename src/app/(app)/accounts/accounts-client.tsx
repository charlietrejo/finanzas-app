...
// QA-41 — Client Component hijo del Server Component accounts/page.tsx.
// Recibe los datos iniciales ya cargados en el servidor (initialAccounts/
// initialDebts) para que el contenido sea visible aunque la hidratación de
// React esté bloqueada por la CSP estricta. Las mutaciones siguen usando el
// cliente browser de Supabase cuando hay hidratación.
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          ...
          {accounts.map((account) => (
            <div key={account.id} className="flex flex-col gap-3 rounded-2xl border border-slate-200 bg-slate-50 p-4">
              <div>
              ...
              <div className="flex w-full justify-center gap-2">
                <Button type="button" variant="default" size="sm" onClick={() => handleEdit(account)}>
                  <Pencil className="h-4 w-4" />
                  Editar
                </Button>

                <Button type="button" variant="default" size="sm" onClick={() => void handleDelete(account.id)}>
